...
//管理者削除
	...
	public int edit(AdminBean ab3) throws Exception{
		Connection con = getConnection();
		PreparedStatement st = con.prepareStatement(
				"update admin set admin_id = ?, admin_pass = ?, admin_name = ? where admin_delete = 1 and admin_code = ?;");
		try {
